...
export const kaushan = localFont({
  src: [{ path: "../app/fonts/KaushanScript-Regular.woff2", weight: "400", style: "normal" }],
  variable: "--font-kaushan",
  display: "swap",
});

export const fontVariables = `${fraunces.variable} ${workSans.variable} ${spaceMono.variable} ${kaushan.variable}`;
